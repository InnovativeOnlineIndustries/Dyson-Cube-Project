...
public class DysonProgressGuiAddon extends BasicScreenAddon {
    ...
    public void drawBackgroundLayer(GuiGraphics guiGraphics, Screen screen, IAssetProvider iAssetProvider, int guiX, int guiY, int mouseX, int mouseY, float partialTicks) {
        ...
        ++y;
        guiGraphics.drawString(Minecraft.getInstance().font, ChatFormatting.BLUE + "Progress: " + new DecimalFormat().format(dyson.getProgress()) + "%", this.getPosX() + guiX, this.getPosY() + guiY + Minecraft.getInstance().font.lineHeight * y, 0xFFFFFF, false);
        ++y;
        guiGraphics.drawString(Minecraft.getInstance().font, ChatFormatting.BLUE + "Power Gen: " + 0 + "FE", this.getPosX() + guiX, this.getPosY() + guiY + Minecraft.getInstance().font.lineHeight * y, 0xFFFFFF, false);
        ++y;
        guiGraphics.drawString(Minecraft.getInstance().font, ChatFormatting.BLUE + "Power Con: " + 0 + "FE", this.getPosX() + guiX, this.getPosY() + guiY + Minecraft.getInstance().font.lineHeight * y, 0xFFFFFF, false);
        ++y;
        guiGraphics.drawString(Minecraft.getInstance().font, ChatFormatting.BLUE + "Beams: " + dyson.getBeams(), this.getPosX() + guiX, this.getPosY() + guiY + Minecraft.getInstance().font.lineHeight * y, 0xFFFFFF, false);
        ++y;
        guiGraphics.drawString(Minecraft.getInstance().font, ChatFormatting.BLUE + "Panels: " + dyson.getSolarPanels() + "/" + dyson.getMaxSolarPanels(), this.getPosX() + guiX, this.getPosY() + guiY + Minecraft.getInstance().font.lineHeight * y, 0xFFFFFF, false);
        ++y;
        ...
        Rectangle area = new Rectangle(this.getPosX() + guiX - 4, this.getPosY() + guiY - 4, 100, Minecraft.getInstance().font.lineHeight * y + 4);
